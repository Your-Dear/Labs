...
# Выделение данных из столбцов 4 и 18
x = data.iloc[:, 3]  # столбец 4
y = data.iloc[:, 17] # столбец 18
...
#Доп Зад
# Определение функции для построения
def sin_wave(x):
    return np.sin(x)
...
# Функция обновления данных для анимации
def update(frame):
    xdata.append(frame)
...
# Сохранение анимации в файл GIF с использованием Pillow
